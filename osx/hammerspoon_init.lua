--------------------------------------------------------------------------------
-- Shamelessly adapted from https://github.com/rtoshiro/hammerspoon-init
--------------------------------------------------------------------------------
...
local hyper_shift = {"alt", "cmd", "ctrl", "shift"}
local laptop_monitor = "Color LCD"
-- local external_monitor = "DELL E2310H"
...
local layouts = {
  {
    ...
    func = function(index, win)
      win:moveToScreen(hs.screen.get(laptop_monitor))
      win:maximize()
    end
  },
  {
    ...
    func = function(index, win)
      if (#hs.screen.allScreens() > 1) then
        win:moveToScreen(hs.screen.get(external_monitor))
...
function config()
  -- Location bindings.
  hs.hotkey.bind(hyper_shift, "l", function() hs.window.focusedWindow():right() end)
  hs.hotkey.bind(hyper_shift, "h", function() hs.window.focusedWindow():left() end)
  hs.hotkey.bind(hyper_shift, "k", function() hs.window.focusedWindow():up() end)
  hs.hotkey.bind(hyper_shift, "j", function() hs.window.focusedWindow():down() end)

  hs.hotkey.bind(hyper_shift, "y", function() hs.window.focusedWindow():upLeft() end)
  hs.hotkey.bind(hyper_shift, "u", function() hs.window.focusedWindow():upRight() end)
  hs.hotkey.bind(hyper_shift, "b", function() hs.window.focusedWindow():downLeft() end)
  hs.hotkey.bind(hyper_shift, "n", function() hs.window.focusedWindow():downRight() end)

  hs.hotkey.bind(hyper_shift, "f", function() hs.window.focusedWindow():maximize() end)
  ...
  hs.hotkey.bind(hyper, ".", function() hs.window.focusedWindow():sendToBack() end)

  -- Window hints.
  hs.hotkey.bind(hyper, "f", function() hs.hints.windowHints() end)

  -- Monitor location bindings.
  ...
  hs.hotkey.bind(hyper_shift, "o", function()
